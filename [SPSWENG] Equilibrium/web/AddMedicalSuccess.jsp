...
<html>
    <head>
        <title>Memo Form Success - EQuilibrium</title>
        <meta charset="UTF-8">
    ...
    <body bgcolor=#E8E8E8>
       ...
       %>
        ...
        <div class = "memoForm" align="center">
            ...
            <div class="titleText">Medical Record has been added!</div><br/>
            <div class="titleText">${response}</div><br/>
           <a href ="addMedical.jsp">Click here to add another medical record...</a><br/>
            <%   
