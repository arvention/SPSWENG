    ...
    <body>
        ...
        <DIV class="content">
            <form action="SaveTraining" method="POST">
                ...
                <span class="nameText">Date Received</span> <input type = "date" name="trainingdate"/><br/><br/>                                 
                <span class="nameText">Event Venue</span>  <input type="text" size="50" name="trainingvenue" placeholder="Training Venue" class="awardName" required /> <br/><br/>
