...
public class SaveTraining extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SaveTraining</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SaveTraining at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        name = request.getParameter("trainingname");
        try {
            trainingDate = new SimpleDateFormat("yyyy-MM-dd").parse(request.getParameter("trainingdate"));
