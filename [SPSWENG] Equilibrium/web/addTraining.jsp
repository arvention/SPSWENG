...
<%
       ...
       %>
		...
		<form action="SaveAward" method="POST" enctype="multipart/form-data">
               	<span class="boxText"> Add Training Event to Employee Record</span>
		<hr width="75%"/>
		<br/>

						                  
                <span class="nameText">Event Name</span>  <input type="text" size="50" name="trainingname" placeholder="Training Name" class="awardName" required /> <br/><br/>
                <span class="nameText">Date Received</span> <input id="datepicker" class="dateReceived" name="trainingreceive"  required="true" /><br/><br/>                                 
                <textarea rows="7" cols = "70" name="trainingNote" class="memoText" placeholder="Enter text here..."></textarea><br/><br/>
